<!-- repository: packages/ts/context | kind: PACKAGE | stack: ts-package -->
...
Omnixys context propagation package for TypeScript.

- Repository path: `packages/ts/context` (relative to the Omnixys root)
...
src/ tenant/principal/correlation context propagation
...
Tenant propagation primitives; SemVer discipline required.
