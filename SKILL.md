...
> Workflow for context (packages/ts/context). Execute this workflow before, during, and
...
- This package is published (`@omnixys/context-ts`); consumers pin versions and rely on SemVer.
